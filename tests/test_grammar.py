...
def arc_ext_grammar(arc_grammar):
    ...
    added_inventions = [
        ...
        "#(lambda (lambda (lambda (rows_to_grid ($0 ($1 (rows (rows_to_grid $2))))))))",
        "#(lambda (lambda (columns_to_grid (concat $0 $1))))",
    ]
